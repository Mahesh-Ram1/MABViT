# Copyright 2023 The Flax Authors + me :D
#
...
def Swiglu(x: ArrayLike, axis: int = -1) -> Array:
...
#   out_dot_general_cls: Any = None
  ...
  def __call__(
    ...
    query, key, value = (
        ...
        dense1(name='value')(inputs_kv),
    )
#     value = flax.linen.gelu(value)
    value = Swiglu(value)
